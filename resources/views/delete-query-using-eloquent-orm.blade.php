...
<div class="bg-danger">
    ...
    <div class="container main-content">
        ...
        <p>You can check out the code for this project using the following link: <a class="text-decoration-none text-info" target="_blank" href="https://github.com/MdZaferEqbal">Laravel Tutorial GitHub Link</a></p>
